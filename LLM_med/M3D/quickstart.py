...
dtype = torch.float16 # or bfloat16, float16, float32      # RuntimeError: "triu_tril_cuda_template" not implemented for 'BFloat16'  # RuntimeError: "triu_tril_cuda_template" not implemented for 'fFloat16'
...
print(f'input_id device:{input_id.device}')
print(f'image_pt device:{image_pt.device}')
