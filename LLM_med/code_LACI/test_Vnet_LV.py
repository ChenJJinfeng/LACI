...
parser.add_argument('--labelnum', type=int,  default=369, help='trained samples')
...
snapshot_path = "/data/chenjinfeng/code/semi_supervised/All_code/code_all/weights/{}/{}/{}/pre_train".format(FLAGS.dataset, FLAGS.exp, FLAGS.labelnum)
...
def test_calculate_metric():
    ...
    save_model_path = os.path.join(snapshot_path, 'iter_6000.pth')   ## 'iter_1000_369.pth'
